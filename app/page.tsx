  ...
  return (
    <div className="relative w-full">
      ...
      <div
        ...
        style={{
          mask: "linear-gradient(to right, transparent 0%, transparent 8%, black 15%, black 85%, transparent 92%, transparent 100%)",
          WebkitMask:
            "linear-gradient(to right, transparent 0%, transparent 8%, black 15%, black 85%, transparent 92%, transparent 100%)",
        }}
      >
